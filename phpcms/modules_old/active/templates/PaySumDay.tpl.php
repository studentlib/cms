...
<input  type="button" id="renovate" value='Sử dụng mẫu'>
</fieldset>
</form>
</div>
...
<form id="edit" action="">
<fieldset>
<legend>Giải thưởng nạp tiền liên tục</legend>
<?php 
...
<label>Số ngày tích lũy&nbsp:&nbsp</label>
...
<?php }?>
<label>Ngưỡng phôi&nbsp:&nbsp</label>
