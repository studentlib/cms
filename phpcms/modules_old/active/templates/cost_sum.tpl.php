...
$(document).ready(function(){
	...
	$('#save').click(function(){
	    ...
	    $.post('index.php?m=active&c=active&a=update_cost_sum',post,function(data){
	        alert(data.msg);
	    },'json');
    }); 
	...
	$('#save_all').click(function(){
       ...
       $.post('index.php?m=active&c=active&a=sync_cost_sum',post,function(data){
            alert(data.msg);
        },'json');
	});
...
$i++;
?>
<label>V.phẩm khuyến mạ<?php echo $i;?></label>
