...
if(is_array($infos)){
	foreach($infos as $info){
	   $info['file']=L($info['file']);
?>
    <tr> 
        <td align="center"><?php echo $info['username']?></td>
        <td align="center"><?php echo $info['module']?></td>
        <td align="center" title="<?php echo $info['file']?>"><?php echo str_cut($info['file'], 30);?></td>
        <td align="center" title="<?php echo $info['data']?>"><?php echo str_cut($info['data'], 200);?></td>
