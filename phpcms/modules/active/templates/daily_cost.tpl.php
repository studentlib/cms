...
$(document).ready(function(){
	...
	$('#save').click(function(){
	    ...
	    $.post('index.php?m=active&c=active&a=update_dailycost',post,function(data){
	        alert(data.msg);
	    },'json');
    }); 
	...
	$('#save_all').click(function(){
       ...
       $.post('index.php?m=active&c=active&a=sync_dailycost',post,function(data){
            alert(data.msg);
        },'json');
	});
...
//			$(v).append('<option value="0">未选择</option>');
//	        for(var it in items)
//		      {
//	        	 var item=items[it];
//	        	$(v).append('<option value="'+item['id']+'">'+item['name']+'</option>');
//		      }
//	    });
//	}
//	
...
//	              {
//	                $(v).append('<option value="'+index+'">'+index+'</option>');
//	              }
//	        });
//	}
//	 changeItems();
