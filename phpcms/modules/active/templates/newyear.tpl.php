...
?>
<label>流水ID:</label><input type="text" name="get"  id="ID_<?php echo $attr_get['ID'];?>" value="<?php echo $attr_get['ID'];?>" style="width:50px ,font-size:15px">

<label>体力:</label><input type="text" name="get" disabled="disabled" id="StrengthValue_<?php echo $attr_get['ID'];?>" value="<?php echo $attr_get['StrengthValue'];?>" style="width:50px">

<label>掉落物品<?php echo $i?>:</label>
...
<label>掉落概率:</label><input type="text" name="get" id="Probability_<?php echo $attr_get['ID'];?>" value="<?php echo $attr_get['Probability'];?>" style="width:80px">
