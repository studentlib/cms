...
//         $lgdt=call_user_func_array('pack',$league);
//         $upkfmt='Iid/Irank/Ilevel/Iexp/Iauto/Smcount/Smaxcount/Imoney/Ileader/Itleader/Ictime/a32name/a256broad/I5flag/I3cond/I8boss/Idate/Iactive/Ilogout/Inid';
//         $data=unpack($upkfmt, $lgdt);
        $len=strlen($lgdt);
