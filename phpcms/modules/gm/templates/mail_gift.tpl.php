...
//            location.reload();
	...
	$('input[name=user]').click(function(e){
	    var op=$(this).val();
	    if(op==1){
			$('.active').css({"float":"left","margin-top":"300px"});
			$('.active003').css({'float':'left','margin-top':'-70px'});
			$('.active013').css({'float':'left','margin-top':'-70px','height':'200px'});
			$('#servers').attr('size','<?php echo count($servers);?>');
			$('#servers').attr('multiple','multiple');
...
<!--     <div class="active" style="float:left;margin-top:300px;">-->
<div class="active">
      <fieldset>
        <legend>区服列表</legend>
    ...
    <div class="active002" >
    <div class="active002-1" >系统邮件</div>
    <div class="active002-2" >发放玩家</div>
    </div>
    <div class="active003"><!-- style="float:left;margin-top:-70px;">-->
            <fieldset><legend>添加玩家</legend>
            <input name="acc" id="acc" type="text" />
             <input name="search" id="search" type="button" value="查找" >
            </fieldset>
    </div>
    <div class="active013"><!-- style="float:left;margin-top:-70px;height:100px;">-->
    <fieldset><legend>查找结果双击添加到发送列表</legend>

    <select name="ids" id="ids" size="10" style="width:80%;" multiple>
	...
	<div style="border: 1px solid #000000;width:1130px;height:1270px;position:absolute;left:249px" >
        ...
        <div class="active006">
            ...
            <div width="77" height="27">全体玩家</div>
        </div>
        <div class="active007">

          <input type="radio" name="user" id="user2" value="2" onmousedown=' window.location.reload()'>

        </div>
        <div class="active008">
            <!--<img src="statics/images/mails/active-08.gif" width="974" height="27" alt="">-->
          <div width="77" height="27" >指定玩家</div>
        </div>
...
<!--     </div> -->
    ...
    <div class="active017">
        ...
        <div style="float:center;">至</div>
        <div style="float:center;margin-top:20px;">至</div>
    </div>
    <div class="active018">
...
<!--     </div> -->
    ...
    <div class="active021" width="84" height="136">
        <!-- <img src="statics/images/mails/active-21.gif" width="84" height="136" alt=""> -->
        <div style="float:right;">发送时间:</div>
        <div style="margin-top:30px;float:right;">等级:</div>
...
<!--     </div> -->
    <div class="active031">
        ...
        <div style="font-size:15px;">邮件标题:</div>
