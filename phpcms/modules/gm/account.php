...
class account extends admin
{
    ...
    public function search()
    {
        ...
        if (!empty($uname) || empty($account) || !empty($sid)) {
            if ($this->_account->changeConnection($sid)) {
    ...
    {
        file_put_contents('/data/www/txmix/po/phpcms/modules/gm/switch.txt', date('Y-m-d H:i:s') . json_encode($data) . PHP_EOL, FILE_APPEND);
