...
//index
$LANG['admin_site_title'] = 'sb2私奔到三国内网后台管理';
...
$LANG['black:forbbiden'] = '禁言';
$LANG['black:ban'] = '限制玩家登陆';
$LANG['black:delban'] = '解除玩家登陆';

$LANG['league:setLeader'] = '设置军团长';

$LANG['gs:kickAll'] = '踢所有玩家下线';
$LANG['gs:shutDownNotice'] = '发送关服TIPS';
$LANG['gs:sendNotice'] = '发送关服公告';
$LANG['gs:updateAll'] = '更新所有配置文件';

$LANG['gm:updateInfo'] = '修改玩家数据';
$LANG['gm:addItem'] = '添加道具';
$LANG['gm:delItem'] = '删除道具';
$LANG['gm:kickOut'] = '踢玩家下线';
$LANG['gm:addGift'] = '添加礼包';
$LANG['gm:updateCarbon'] = '修改玩家关卡信息'
;
$LANG['gift:createCode'] = '生成激活码';
$LANG['gift:delCode'] = '删除激活码';

$LANG['vip:buy'] = '虚拟充值';
$LANG['active:syncAll'] = '同步所有活动';
$LANG['active:sync_login'] = '同步连续登陆活动';
$LANG['active:sync_discount'] = '同步充值特惠活动';
$LANG['active:sync_acc_charge'] = '同步累计充值活动';
$LANG['active:sync_cost_sum'] = '同步累计消费活动';
$LANG['active:sync_rank'] = '同步排行双倍活动';
$LANG['active:update'] = '修改活动配置';
$LANG['active:update_discount'] = '修改充值特惠奖励';
$LANG['active:update_login'] = '修改连续登陆奖励';
$LANG['active:update_acc_charge'] = '修改累计充值奖励';
$LANG['active:update_cost_sum'] = '修改累计消费奖励';
$LANG['active:update_rank'] = '修改排行双倍奖励';
$LANG['broad:save'] = '修改游戏公告';
$LANG['mail_gift:sendUsersMail'] = '发送多个玩家邮件';
$LANG['mail_gift:sendAllUsersMail'] = '发送所有玩家邮件';
